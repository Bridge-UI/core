// prettier-ignore
export interface NumberInputColorItem {
  "base": string;
  "focus": string;
}

// prettier-ignore
export interface NumberInputColor {
  "dark": NumberInputColorItem;
  "primary": NumberInputColorItem;
  "secondary": NumberInputColorItem;
  "success": NumberInputColorItem;
  "error": NumberInputColorItem;
  "warning": NumberInputColorItem;
  "info": NumberInputColorItem;
}

// prettier-ignore
export const outlineProps: NumberInputColor = {
  "dark": {
...
// prettier-ignore
export const filledProps: NumberInputColor = {
  "dark": {
...
// prettier-ignore
export const underlinedProps: NumberInputColor = {
  "dark": {
