// prettier-ignore
export interface PasswordInputColorItem {
  "base": string;
  "focus": string;
}

// prettier-ignore
export interface PasswordInputColor {
  "dark": PasswordInputColorItem;
  "primary": PasswordInputColorItem;
  "secondary": PasswordInputColorItem;
  "success": PasswordInputColorItem;
  "error": PasswordInputColorItem;
  "warning": PasswordInputColorItem;
  "info": PasswordInputColorItem;
}

// prettier-ignore
export const outlineProps: PasswordInputColor = {
  "dark": {
...
// prettier-ignore
export const filledProps: PasswordInputColor = {
  "dark": {
...
// prettier-ignore
export const underlinedProps: PasswordInputColor = {
  "dark": {
