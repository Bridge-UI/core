// prettier-ignore
export interface TextareaColorItem {
  "base": string;
  "focus": string;
}

// prettier-ignore
export interface TextareaColor {
  "dark": TextareaColorItem;
  "primary": TextareaColorItem;
  "secondary": TextareaColorItem;
  "success": TextareaColorItem;
  "error": TextareaColorItem;
  "warning": TextareaColorItem;
  "info": TextareaColorItem;
}

// prettier-ignore
export const outlineProps: TextareaColor = {
  "dark": {
...
// prettier-ignore
export const filledProps: TextareaColor = {
  "dark": {
...
// prettier-ignore
export const underlinedProps: TextareaColor = {
  "dark": {
