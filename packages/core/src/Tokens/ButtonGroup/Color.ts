/**
 * Divider fill shown in the 1px gap between grouped children.
 */
...
/**
 * Button group divider colors use background utilities (not `border-*`) so host
 * resets like `* { border-color: … }` cannot wash out semantic colors.
 */
