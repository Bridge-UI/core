...
export const sizeProps: ListboxSize = {
  "md": {
    "panel": {
      ...
      "option": "px-2 py-2 text-sm leading-none",
      "primary": "text-sm font-medium leading-none",
    },
    "menu": {
      "check": "size-4",
      "secondary": "mt-0.5 text-xs",
      "message": "px-2 py-3 text-sm",
      "option": "px-2 py-1.5 text-sm leading-none",
      "primary": "text-sm font-medium leading-none",
    },
  },
  "2xl": {
    "menu": {
      ...
      "option": "px-3 py-2.5 text-lg leading-none",
      "primary": "text-lg font-medium leading-none",
    },
    "panel": {
      "check": "size-5",
      "secondary": "mt-0.5 text-sm",
  ...
  "sm": {
    ...
    "menu": {
      ...
      "option": "px-2 py-1 text-xs leading-none",
      "primary": "text-xs font-medium leading-none",
    },
  },
  "2xs": {
    "panel": {
    ...
    "menu": {
      ...
      "option": "px-2 py-0.5 text-2xs leading-none",
      "primary": "text-2xs font-medium leading-none",
    },
  },
  "xs": {
    "menu": {
    ...
    "panel": {
      ...
      "secondary": "mt-0.5 text-2xs",
      "message": "px-2 py-2.5 text-xs",
      "option": "px-2 py-1.5 text-xs leading-none",
      "primary": "text-xs font-medium leading-none",
    },
  },
  "lg": {
    ...
    "panel": {
      ...
      "option": "px-2 py-2.5 text-base leading-none",
      "primary": "text-base font-medium leading-none",
    },
  },
  "xl": {
    "panel": {
