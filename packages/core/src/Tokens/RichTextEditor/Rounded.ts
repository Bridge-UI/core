/**
 * Border radius tokens for RichTextEditor surfaces.
 */
export interface RichTextEditorRounded {
  /**
...
/**
 * Default border radius classes for RichTextEditor surfaces.
 */
export const roundedProps: RichTextEditorRounded = {
  "xs": "rounded-xs",
  "sm": "rounded-sm",
  "md": "rounded-md",
  "lg": "rounded-lg",
