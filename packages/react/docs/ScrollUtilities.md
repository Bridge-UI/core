...
```tsx
<div className="bridge-scroll-fade-y overflow-y-auto">…</div>
```

### Horizontal fade

```tsx
<div className="flex bridge-scroll-fade-x overflow-x-auto">…</div>
```

### Hide scrollbar

```tsx
<div className="bridge-scroll-fade-y bridge-hide-scrollbar overflow-y-auto">
  …
</div>
```
...
```tsx
<div className="bridge-scroll-fade-y bridge-scroll-fade-none overflow-y-auto">
  …
</div>
```
...
```tsx
<div className="bridge-soft-scrollbar overflow-y-auto">…</div>
```
