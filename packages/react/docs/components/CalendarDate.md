...
```ts
import { CalendarDate } from "@bridge-ui/react/Components/CalendarDate";
```
...
| `onViewDateChange` | `(date: Date) => void` | Called when the displayed month should change. |
