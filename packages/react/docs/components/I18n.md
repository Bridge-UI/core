...
```ts
import { createI18nextAdapter } from "@bridge-ui/react/Adapters/Examples/i18n-i18next";
...
Other ready adapters:

| Import                                               | Library                  | Replace / plural |
| ---------------------------------------------------- | ------------------------ | ---------------- |
| `@bridge-ui/react/Adapters/Examples/i18n-dictionary` | In-memory dictionary     | Yes (`\|` forms) |
| `@bridge-ui/react/Adapters/Examples/i18n-i18next`    | i18next (`i18next` peer) | Yes (via lib)    |
