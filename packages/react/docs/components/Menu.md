...
| `matchWidth`        | `boolean`                                               | `false`        | When true, the panel width matches the trigger / anchor.                                                                                                                                                                                                                             |
