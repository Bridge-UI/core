...
test("it should render description when description prop is provided", () => {
  cy.mount(<TextField aria-label="Field" description="Helper text" />);
...
test("it should render start icon when startIcon prop is set", () => {
  cy.mount(<TextField aria-label="Field" startIcon={CircleAlert} />);
...
test("it should set aria-describedby when description is shown", () => {
  cy.mount(<TextField id="field-id" aria-label="Field" description="Helper" />);
...
test("it should merge className with root classes", () => {
  cy.mount(<TextField aria-label="Field" className="custom-field" />);

  cy.get(".w-full").should("have.class", "custom-field");
});

test("it should forward placeholder to the input", () => {
  cy.mount(<TextField aria-label="Field" placeholder="Enter email" />);
