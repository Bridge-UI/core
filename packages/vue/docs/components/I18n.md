...
import { createVueI18nAdapter } from "@bridge-ui/vue/Adapters/Examples/i18n-vue-i18n";
...
| -------------------------------------------------- | -------------------------- | ---------------- |
| `@bridge-ui/vue/Adapters/Examples/i18n-dictionary` | In-memory dictionary       | Yes (`\|` forms) |
| `@bridge-ui/vue/Adapters/Examples/i18n-vue-i18n`   | vue-i18n (`vue-i18n` peer) | Yes (via lib)    |
